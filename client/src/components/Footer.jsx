      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <div className="footer-social">
            <a href="www.twitter.com" className="social-link" aria-label="Twitter">
            ...
            <a href="www.linkedin.com" className="social-link" aria-label="LinkedIn">
            ...
            <a href="www.instagram.com" className="social-link" aria-label="Instagram">
